...
func TestGenerateMainGo_Content(t *testing.T) {
	...
	assert.Contains(t, s, "weave: unsupported %s")
	assert.Contains(t, s, "removedSandboxRuntimeFlag")
	assert.Contains(t, s, "--sandbox-mode")
	assert.Contains(t, s, "--sandbox-writable")
	assert.Contains(t, s, "--sandbox-deny_read")
	assert.Contains(t, s, "--sandbox-deny_write")
	assert.Contains(t, s, "--sandbox-network")
