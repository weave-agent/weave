...
func runParallel(ctx context.Context, agent *AgentDef, tasks []any, cwd string, broker *Broker, cfgPath, projectDir string) (sdk.ToolResult, error) {
...
func runChain(ctx context.Context, agent *AgentDef, chain []any, cwd string, broker *Broker, cfgPath, projectDir string) (sdk.ToolResult, error) {
